...
common_derives! {
    pub struct Segment {
        pub text: String,
        pub speaker: String,
        /// Startzeit des Blocks im Gespraech, bereits als mm:ss formatiert.
        ///
        /// Seit die Block-Bildung an den letzten Block DESSELBEN Kanals
        /// anhaengt, ueberlappen sich Bloecke in der Zeit: waehrend die eine
        /// Seite spricht, wirft die andere ein. Ohne Zeitmarke liest ein
        /// Sprachmodell die Abfolge als zwei Monologe und erfindet eine
        /// Kausalitaet, die es im Gespraech nie gab.
...
mod tests {
    ...
    tpl_snapshot!(
        ...
        TestTranscripts {
            transcripts: vec![
                Transcript {
                    segments: vec![Segment { speaker: "Alice".to_string(), text: "First meeting".to_string(), start_label: None }],
                    started_at: None,
                    ended_at: None,
                },
                Transcript {
                    segments: vec![Segment { speaker: "Bob".to_string(), text: "Second meeting".to_string(), start_label: None }],
                    started_at: None,
                    ended_at: None,
                },
            ],
    ...
    tpl_snapshot!(
        test_macro_transcripts_mit_zeitmarke,
        TestTranscripts {
            transcripts: vec![Transcript {
                segments: vec![
                    Segment { speaker: "Alice".to_string(), text: "Wir fangen an".to_string(), start_label: Some("00:12".to_string()) },
                    Segment { speaker: "Bob".to_string(), text: "Ja".to_string(), start_label: Some("01:05".to_string()) },
                ],
                started_at: None,
                ended_at: None,
            }],
