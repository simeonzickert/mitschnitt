...
// Die eigenen Namen zuerst; die geerbten bleiben als Ersatz, damit eine
// bereits installierte Kopie ihr Symbol behaelt.
fn default_app_icon() -> Option<Pixbuf> {
    icon_theme_pixbuf("media.zickert.mitschnitt")
        .or_else(|| icon_theme_pixbuf("mitschnitt"))
        .or_else(|| icon_theme_pixbuf("com.hyprnote.dev"))
