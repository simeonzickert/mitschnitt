...
async fn applies_canonical_graph_idempotently_and_marks_rows_for_e2ee() {
    ...
    // Die frühere Prüfung auf `e2ee_dirty_rows` ist mit der Cloud-Schicht entfallen
    // (Migration 20260901120000_drop_cloud_layer). Sie belegte, dass eine Aufnahme
    // zur Synchronisation vorgemerkt wird — es gibt nichts mehr zu synchronisieren.
    // Was dieser Test weiterhin belegt, steht oben: die Aufnahme landet lokal
