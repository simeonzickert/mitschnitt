...
// NICHT UMBENENNEN. Dieser Schluessel wird in die gespeicherten Metadaten
// jeder uebernommenen Sitzung geschrieben (`apply.rs`) und beim naechsten Lauf
// wieder daraus gelesen, um zu erkennen, was schon uebernommen wurde. Ein
// neuer Name macht alle bestehenden Marker unsichtbar -- die Folge waeren
// doppelt uebernommene Sitzungen, nicht ein Fehler. Aendern nur mit einem
// Lesepfad, der beide Schluessel akzeptiert.
