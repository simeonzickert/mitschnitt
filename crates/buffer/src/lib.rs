...
fn transform_mentions_in_markdown(markdown: &str) -> String {
    ...
    re.replace_all(markdown, |caps: &regex::Captures| {
        ...
        format!(
            r#"<a class="mention" data-mention="true" data-id="{}" data-type="{}" data-label="{}" href="javascript:void(0)" onclick="event.preventDefault(); if (window.__MITSCHNITT_NAVIGATE__) window.__MITSCHNITT_NAVIGATE__('{}');">@{}</a>"#,
...
## Stay Connected
- Follow updates on [X](https://example.invalid/x).
- Join the community and chat on [Discord](https://example.invalid/chat). 

# Participants:

* [Mads Verlin](mailto:mads@example.invalid)
* [Tom Kestroll](mailto:tom@example.invalid)
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Mitschnitt: Enhanced Meeting Notes

# Objective: Introduce Mitschnitt as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Share Mitschnitt with the team.
...
# Further Information: Follow updates on [X](https://example.invalid/x) and [Discord](https://example.invalid/chat).
        "#;

        insta::assert_snapshot!(md_to_md(input).unwrap().to_string(), @"# Further Information: Follow updates on [X](https://example.invalid/x) and [Discord](https://example.invalid/chat).");
    }
...
"#;
        ...
        <ul>
        <li>Follow updates on <a href="https://example.invalid/x">X</a>.</li>
        <li>Join the community and chat on <a href="https://example.invalid/chat">Discord</a>.</li>
        </ul>
        "#);
    }
