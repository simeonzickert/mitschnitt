...
mod tests {
    ...
    // Haengt am Uebergabe-Handwerk: wird der angehaengte Rest beim Abschluss
    // wirklich mitgegeben, und zwar am Ende. Was gesprochen wird, spielt keine
    // Rolle -- es muss nur ueberhaupt als Sprache erkannt werden, und das tut
    // der Testton (gemessen: 93,7 % seiner Abtastwerte).
    #[test]
