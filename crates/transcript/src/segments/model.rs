...
pub(super) struct SpeakerState {
    ...
    /// hat (Fork, 08.09.2026).
    ///
    /// Genau hier bricht die Annahme "ein Kanal, ein Mensch". Sie traegt jedes
    /// Zwei-Kanal-Gespraech und ist dort richtig -- aber bei einer Raumaufnahme
    /// sitzen alle Anwesenden auf demselben Kanal, und die kanalweite Zuweisung
    /// wuerde ihnen allen denselben Namen geben.
    ///
    /// Ein Kanal mit genau einem gefundenen Sprecher bleibt bewusst draussen:
    /// dort ist die Kanal-Aussage weiterhin wahr.
    pub(super) multi_speaker_channels: HashSet<ChannelProfile>,
}
