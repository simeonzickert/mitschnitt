...
impl Notification {
    ...
    pub fn default_action_label(&self) -> &str {
        self.action_label.as_deref().unwrap_or("Open Mitschnitt")
    }
...
pub fn stop_countdown_text(remaining: Duration) -> String {
    ...
    format!("Mitschnitt will stop listening in {seconds} seconds.")
}
...
mod tests {
    ...
    fn stop_countdown_copy_matches_macos() {
        let notification = Notification::builder()
            ...
            .message("Mitschnitt will stop listening soon.")
            .action_label("Stop")
        ...
        assert_eq!(
            ...
            "Mitschnitt will stop listening in 5 seconds."
        );
        assert_eq!(
