                ...
                .map(|(channel_index, channel)| {
                    ...
                    let words = channel
                        ...
                        .map(|word| batch::Word {
                            ...
                            confidence: word.confidence.unwrap_or(1.0),
                            // Fork (03.09.2026): dieselbe Falle wie in
                            // `transcribe-soniqo` -- `unwrap_or(1.0)` presst
                            // "keine Angabe" in eine Zahl, die wie eine
                            // Messung aussieht. Die Wahrheit reist daneben mit.
