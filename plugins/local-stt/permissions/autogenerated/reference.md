...
- `allow-vocabulary-risky-aliases`
- `allow-vocabulary-proposals`
...
`local-stt:allow-vocabulary-proposals`

</td>
<td>

Enables the vocabulary_proposals command without any pre-configured scope.
...
`local-stt:deny-vocabulary-proposals`

</td>
<td>

Denies the vocabulary_proposals command without any pre-configured scope.
...
`local-stt:allow-vocabulary-risky-aliases`

</td>
<td>

Enables the vocabulary_risky_aliases command without any pre-configured scope.
...
`local-stt:deny-vocabulary-risky-aliases`

</td>
<td>

Denies the vocabulary_risky_aliases command without any pre-configured scope.
