...
// Entscheid des Eigentuemers 22.09.2026: ext.rs setzt keinen Menueleisten-Text mehr, deshalb ist
// die gesamte menu_bar_title-Kette (dieses Limit, menu_bar_title,
// menu_bar_label, duration_label) im normalen Build unerreicht -- nur noch
// ihre eigenen Tests rufen sie auf. Bewusst behalten statt geloescht: die
// Formatierlogik ist geprueft und pur, falls ein Titel-Feature zurueckkommt.
#[allow(dead_code)]
...
// Entscheid des Eigentuemers 22.09.2026: ohne Aufrufer in ext.rs (siehe Kommentar oben bei
// MAX_MENU_BAR_LABEL_WIDTH), nur noch von den eigenen Tests genutzt.
#[allow(dead_code)]
