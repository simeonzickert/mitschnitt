...
pub enum Error {
    ...
    #[error("cached update {version} failed signature verification and was discarded")]
    CachedUpdateSignatureInvalid { version: String },
    #[error("updater pubkey unavailable in plugin config")]
    UpdaterPubkeyUnavailable,
