    ...
    pub fn build(self) -> tauri::plugin::TauriPlugin<tauri::Wry> {
        ...
        tauri::plugin::Builder::new(PLUGIN_NAME)
            ...
            .setup(move |app, _api| {
                ...
                // Bis zum 02.09.2026 lief hier cleanup_legacy_logs: es loeschte
                // log, log.1 .. log.5 unter <data_dir>/hyprnote -- dem
                // Datenordner des produktiven Originals auf demselben Rechner.
                // Dieser Fork hat dort nie geschrieben (seine Logs liegen
                // unter ~/Library/Logs/<identifier>/app.log, s. ext.rs), also
                // gab es fuer ihn nichts aufzuraeumen, nur fremde Dateien zu
                // treffen. Ersatzlos weg; keine Cleanup-Schleife in fremde
                // Ordner wieder einbauen.
