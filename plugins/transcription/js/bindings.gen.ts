...
export type BatchProvider = "whispercpp" | "deepgram" | "soniox" | "assemblyai" | "fireworks" | "openai" | "openrouter" | "siliconflow" | "zai" | "gladia" | "elevenlabs" | "pyannote" | "dashscope" | "mistral" | "anarlog" | "soniqo" | "applespeech" | "aquavoice" | "cartesia" | "cohere" | "aws_transcribe" | "azure_speech" | "google_cloud" | "google_generative_ai" | "groq" | "revai" | "speechmatics" | "together" | "xai"
...
export type BatchWord = { word: string; start: number; end: number; confidence: number;
/**
 ...
 */
measured_confidence?: number | null; channel?: number; speaker: number | null; punctuated_word: string | null }
...
export type TranscriptionParams = { session_id: string; provider: BatchProvider; file_path: string; model?: string | null; base_url: string; api_key: string; languages?: string[]; keywords?: string[];
/**
 ...
 */
vocabulary?: string[]; num_speakers?: number | null; min_speakers?: number | null; max_speakers?: number | null }
