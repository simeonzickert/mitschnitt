...
mod tests {
    ...
    /// Der lokale whisper.cpp-Dienst laeuft progressiv und braucht deshalb die
    /// Leerlauf-Uhr. Dieselbe Zusage lief bis zum 01.09.2026 ueber
    /// `BatchProvider::Am` (Argmax-Strecke) und eine Loopback-Adresse.
    #[test]
