...
pub struct TranscriptionParams {
    ...
    #[serde(default)]
    pub keywords: Vec<String>,
    /// Die eingetragene Stichwortliste, Zeile fuer Zeile -- getrennt von `keywords`.
    ///
    /// `keywords` ist eine gemischte Tuete (Teilnehmer, Kalendernamen UND
    /// automatisch aus der Notiz gezogene Schlagwoerter). Als Hinweis an ein
    /// Modell ist das richtig, als Vorlage fuer ein Suchen-und-Ersetzen waere
    /// es gefaehrlich. Hier steht nur, was ein Mensch eingetragen hat.
    #[serde(default)]
...
mod tests {
    ...
    #[test]
    fn defaults_local_server_capture_to_batch_mode() {
