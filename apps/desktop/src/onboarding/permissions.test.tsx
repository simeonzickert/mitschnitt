...
describe("PermissionsSection", () => {
  ...
  it("collects Accessibility permission on macOS", () => {
    ...
    expect(screen.getByText("Help Mitschnitt listen to you")).toBeTruthy();
    expect(screen.getByText("Help Mitschnitt listen to others")).toBeTruthy();
    expect(
      screen.getByText("Help Mitschnitt read meeting activity"),
    ).toBeTruthy();
    expect(
      screen
  ...
  it("waits for microphone and system audio before continuing, regardless of Accessibility", () => {
  ...
  it("continues without Accessibility granted", () => {
    const onContinue = vi.fn();
    mocks.permissions.microphone.status = "authorized";
    mocks.permissions.systemAudio.status = "authorized";
  ...
  it("preserves the audio-only flow outside macOS", () => {
    ...
    expect(
      screen.queryByText("Help Mitschnitt read meeting activity"),
    ).toBeNull();
  ...
  it("routes an assisted Accessibility pane to the guided flow", () => {
    ...
    expect(row.getAttribute("title")).toBe(
      "Opens System Settings and guides you to add Mitschnitt to the Accessibility list",
    );
