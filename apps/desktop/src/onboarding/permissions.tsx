...
function PermissionsSectionContent({
  ...
  // Accessibility is optional (it only lets Mitschnitt read the meeting
  // title and controls) and must not gate progress here: this step cannot
  // be skipped, so requiring it would leave anyone who declines it with no
  // way to continue.
  const isComplete =
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-2">
        <PermissionBlock
          enabledLabel={t`Mitschnitt can hear your voice`}
          enableLabel={t`Help Mitschnitt listen to you`}
        ...
        <PermissionBlock
          enabledLabel={t`Mitschnitt can hear others`}
          enableLabel={t`Help Mitschnitt listen to others`}
        ...
        {accessibility && (
          <PermissionBlock
            enabledLabel={t`Mitschnitt can read meeting details`}
            enableLabel={t`Help Mitschnitt read meeting activity`}
            enabledBody={t`Meeting details access turned on`}
            enableBody={
              accessibilityGuidance
                ? t`Opens System Settings and guides you to add Mitschnitt to the ${accessibilityGuidance.paneTitle ?? "Privacy"} list`
