  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      <div
        ...
        data-testid="settings-nav-groups"
      >
      ...
      {/*
        Namensnennung ist Bedingung der Weitergabe (u. a. CC-BY-4.0 fuer die
        Parakeet-Modelle), nicht Hoeflichkeit. Sie muss auffindbar sein, nicht
        sichtbar: ein Zeichen in der Ecke statt einer eigenen Zeile in der
        Navigation. Der Inhalt dahinter bleibt vollstaendig.
      */}
        ...
        <button
          ...
          className={cn([
            ...
            activeTab === "about"
              ...
              : "text-muted-foreground/60 hover:bg-sidebar-accent/50 hover:text-foreground",
          ])}
        >
