    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-1 truncate font-medium">
          {/* Fork: siehe details.tsx -- der eigene Eintrag (id == userId) heisst
              "You", damit die Liste nicht einen namenlosen Fremdkontakt und den
              Nutzer selbst gleich benennt. */}
          {personName ||
            personEmail ||
            (person.id === person.userId ? "You" : "Unnamed")}
        </div>
