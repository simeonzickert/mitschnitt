// `cloudsync_workspace_binding` unten ist Bestand: der Schluessel liegt so in
// `app_settings` jeder bestehenden Datenbank und traegt lokal die NOT-NULL-Spalte
// `sessions.workspace_id`. Nicht umbenennen -- siehe crates/db-app/src/workspace.rs.
...
export function createHuman({
  ...
  name,
  email = "",
  entryPoint: _entryPoint = "contacts",
}: {
  ownerUserId?: string;
  name: string;
  email?: string;
