      ...
      <section>
        <div className="flex flex-col gap-4">
          {!appStoreBuild && (
            <>
              <SettingSwitchRow
                title={<Trans>Start Mitschnitt at login</Trans>}
                description={
                  <Trans>Have Mitschnitt ready when you sign in.</Trans>
                }
              ...
              <SettingSwitchRow
                ...
                description={
                  <Trans>
                    Stay current with updates installed the next time Mitschnitt
                    opens.
                  </Trans>
                }
          ...
          {isMacos && (
            <SettingSwitchRow
              ...
              description={
                <Trans>Show Mitschnitt in the Dock and app switcher.</Trans>
              }
          ...
          <SettingSwitchRow
            ...
            description={
              isMacos ? (
                <Trans>Open Mitschnitt from the menu bar.</Trans>
              ) : undefined
            }
