...
import { MitschnittProviderIcon, ProviderLobeIcon } from "~/settings/ai/shared";
...
const _PROVIDERS = [
  {
    ...
    // Kein Ziel mehr: die Adresse war `VITE_API_URL` + "/llm", also die
...
// Fork: the hosted "anarlog" cloud language-model provider is not offered as a
// selectable option — its backend is the vendor cloud that this fork removed,
// and it required sign-in plus a Pro entitlement that no longer exist. All
// other cloud providers (Anthropic, OpenAI, OpenRouter, ...) stay. The id
// remains in the ProviderId union below so provider-id comparisons elsewhere
// keep type-checking.
