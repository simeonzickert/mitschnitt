...
// Fork: this build has no account and no paid tier, so the sign-in and
// entitlement requirement kinds can never block. They stay in the type because
// the (runtime-filtered) hosted provider definitions still declare them.
