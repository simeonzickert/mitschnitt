...
// Bewusst der ALTE Hinweistext samt altem Stempel: dieser Datensatz stellt
// eine Bestandszeile von 2026-08-21 dar. Nach der Textaenderung vom
// 01.09.2026 (siehe meeting-consent.ts) muss genau so eine Zeile weiter
// gueltig sein -- wer sie auf den neuen Text zieht, testet die Migration weg.
const DISCLOSURE =
