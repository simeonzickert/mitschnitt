...
// Dieser Satz wird in den Chat des laufenden Meetings gepostet und von den
// anderen Teilnehmern gelesen. Bis zum 01.09.2026 hing `https://anarlog.so`
// daran -- die App bewarb also bei jeder Aufnahme ein fremdes Produkt bei
// Dritten. Kein Ersatzlink: es gibt keine Seite zu dieser App.
// Wer den Text aendert, bewegt MEETING_DISCLOSURE_MESSAGE_VERSION mit
// (siehe meeting-consent.ts).
