...
import tagWordImportance from "~/stt/keyword-importance";
...
export function buildKeywords({
  ...
  return normalizeKeywordList([
    ...sessionParticipantTerms,
    ...eventParticipantTerms,
    // Nur die richtigen Schreibweisen. Die eingetragenen Verhoerungen gehoeren
    // in `vocabulary`, nicht in einen Hinweis an das Modell.
    ...dictionaryCanonicalTerms(dictionaryTerms),
    ...keywords,
    ...keyphrases,
