...
function mapSessionContentRow(
  ...
  return {
    ...
    // G4 (Fix-Runde 2): through the one bottleneck, not a raw parse -- the
    // snapshot feeds the AI tasks, the chat, the enhancer and move-contents.
    event: getSessionEvent(row),
