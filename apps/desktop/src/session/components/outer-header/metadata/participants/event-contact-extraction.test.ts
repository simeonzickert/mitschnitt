...
describe("event contact extraction", () => {
  ...
  test("creates a contact from the participant when the human is missing", () => {
    const { result, changes } = planExtractedContactToHuman({
      ...
      mappingSource: "auto",
      participant: {
        name: "marco.bergen@example.com",
        email: "marco.bergen@example.com",
      },
      contacts: [],
    });
    ...
    const extraction = extractEventContacts({
      context: {
        ...
        candidates: [
          ...
          {
            name: "tom@kestroll.example",
            email: "tom@kestroll.example",
          },
        ],
      },
    });
    ...
    const extraction = extractEventContacts({
      context: {
        ...
        candidates: [
          ...
          {
            name: "john@other.example",
            email: "john@other.example",
          },
        ],
      },
    });
