...
>(
  (
    ...
    // Das Transkript traegt keinen ProseMirror-Editor, hat aber eine eigene
    // Suchquelle (registerTranscriptSearchSource in virtual-segments.tsx), die
    // auch die nicht gerenderten Bloecke findet. Die Leiste gehoert deshalb
    // auch hierher -- nur Ersetzen bleibt draussen, weil es ohne Editor
    // wirkungslos waere.
    const isTranscriptTab = renderedCurrentTab.type === "transcript";
