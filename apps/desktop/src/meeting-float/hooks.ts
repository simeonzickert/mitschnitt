...
export function createMeetingFloatLabelContext(
  ...
  return {
    ...
    // Diese Fassung kennt die Bloecke nicht -- der Aufrufer, der sie hat,
    // reichert den Kontext an (`route-state.ts`,
    // `getFloatingTranscriptBubbles`). Hier ausdruecklich "keiner" statt
