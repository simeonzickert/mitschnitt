    ...
    >
      ...
      >
        ...
        >
          ...
          {/*
            Hier stand ein Hilfe-Menue mit drei Eintraegen: "Documentation" auf
            docs.anarlog.so, "Report a Bug" und "Suggest a Feature" beide in den
            Discord des Originals. Fuer diesen Fork gibt es weder Doku noch
            Meldestelle -- ein Menue, das den Nutzer zur Belegschaft eines
            fremden Produkts schickt, ist schlechter als kein Menue. Kommt
            wieder, sobald es eine eigene Anlaufstelle gibt (01.09.2026).
          */}
        </nav>
