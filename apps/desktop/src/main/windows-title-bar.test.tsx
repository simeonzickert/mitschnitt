...
describe("WindowsTitleBar", () => {
  ...
  it("renders the sidebar and application menus in the draggable title bar", async () => {
    ...
    // Kein "Help"-Menue mehr: seine drei Eintraege zeigten alle ins fremde
    // Produkt (docs.anarlog.so, zweimal anarlog.so/discord) und sind am
    // 01.09.2026 entfernt worden. Bleibt raus, bis es eine eigene
    // Anlaufstelle gibt.
