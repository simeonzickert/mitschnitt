...
type LocalTools = {
  ...
  apply_session_correction: {
    ...
    output: {
      ...
      dictionaryChanges?: {
        addedTerms: string[];
        learnedAliases: Array<{ canonical: string; alias: string }>;
        // Verworfene Verhoerungen. Was nicht wirkt, heisst nicht gelernt --
        // ohne dieses Feld koennen typisierte Verbraucher die Ablehnung nicht
        // auswerten.
        ignoredAliases: Array<{ canonical: string; alias: string }>;
      };
    };
  };
  move_meeting_contents: {
