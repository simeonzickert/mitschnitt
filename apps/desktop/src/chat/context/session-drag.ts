...
// Nur der Typ eines Ziehvorgangs innerhalb des eigenen Fensters. Er wird beim
// Ablegen gelesen und nirgends gespeichert; Schreiber und Leser liegen im
// selben Bundle.
const SESSION_CONTEXT_DRAG_TYPE = "application/x-mitschnitt-session-context";
