...
vi.mock("~/stt/render-transcript", async (importOriginal) => {
  ...
  return {
    ...
    // Bewusst NICHT gemockt: die mm:ss-Formatierung ist reine Rechnung ohne
    // Seiteneffekt, und der Test soll die echte Zeitmarke im Kontext sehen.
          ...
          segments: [
            {
              ...
              text: "Transcript text",
              // Ohne diese Zeitmarke liest das Sprachmodell zeitlich
              // ueberlappende Bloecke als zwei aufeinanderfolgende Monologe.
              startLabel: "01:05",
            },
          ],
          startedAt: 100,
